...
namespace KoreaCommon.Fish.해양수산부.For품목별물류센터입출고현황정보
{
    using System;
    using System.IO;
    using System.Net;
    ...
    public class 품목별물류센터입출고현황정보API
    {
        ...
        public async Task<품목별물류센터입출고현황정보> Get품목별물류센터입출고현황정보(string lgistCnterCode="", string lgistCnterNm = "", string mprcStdCode = "", string mprcStdCodeNm = "", 
            string baseDt = "20230502", int numOfRows = 10, int pageNo = 1, string dataType = "json")
        {
            ...
            using (HttpClient client = new HttpClient())
            {
                try
                {
                    ...
                    품목별물류센터입출고현황정보 result = JsonConvert.DeserializeObject<품목별물류센터입출고현황정보>(data);
                    return result;
                }
    ...
    public class Item
    {
        ...
        [JsonProperty("wrhousngQy")]
        public string WrhousngQy { get; set; }

        [JsonProperty("dlivyQy")]
        public string DlivyQy { get; set; }

        [JsonProperty("invntryQy")]
        public string InvntryQy { get; set; }

        [JsonProperty("kgCnvrsnWrhousngQy")]
        public string KgCnvrsnWrhousngQy { get; set; }

        [JsonProperty("kgCnvrsnDlivyQy")]
        public string KgCnvrsnDlivyQy { get; set; }
