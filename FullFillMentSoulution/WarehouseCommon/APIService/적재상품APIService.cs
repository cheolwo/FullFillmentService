...
namespace WarehouseCommon.APIService
{
    public class 적재상품ApiService
    {
        ...
        public async Task<List<적재상품>> GetAll적재상품()
        {
            ...
            var 적재상품List = await response.Content.ReadFromJsonAsync<List<적재상품>>();
            return 적재상품List;
        }

        public async Task<적재상품> Get적재상품ById(string id)
        {
            var response = await _httpClient.GetAsync($"api/적재상품/{id}");
            if (response.IsSuccessStatusCode)
            {
                var 적재상품 = await response.Content.ReadFromJsonAsync<적재상품>();
                return 적재상품;
            }
        ...
        public async Task<적재상품> Create적재상품(적재상품 적재상품)
        {
            var response = await _httpClient.PostAsJsonAsync("api/적재상품", 적재상품);
            response.EnsureSuccessStatusCode();
            var created적재상품 = await response.Content.ReadFromJsonAsync<적재상품>();
            return created적재상품;
        }

        public async Task Update적재상품(string id, 적재상품 updated적재상품)
        {
        ...
        public async Task<적재상품> Get적재상품ByIdWith출고상품(string id)
        {
        ...
        public async Task<List<적재상품>> Get적재상품By창고Id(string 창고Id)
        {
        ...
        public async Task<List<적재상품>> Get적재상품By창고상품Id(string 창고상품Id)
        {
        ...
        public async Task<List<적재상품>> Get적재상품By입고상품Id(string 입고상품Id)
        {
