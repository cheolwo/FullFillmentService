...
using 주문Common.Actor.Config.주문Common.Actor.Config;
using 주문Common.Actor.Config04;

namespace 주문FrontCommon.Actor
{
    public class 주문자CommandContext : ActorCommandContext
    {
        public 주문자CommandContext(ActorContextOptions options)
            : base(options)
        {
